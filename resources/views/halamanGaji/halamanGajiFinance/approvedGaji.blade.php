                  ...
                  <div class="card-body">
                    <div class="list-product-header">
                      <div>
                        ...
                        <a class="btn btn-primary" href="/dashboardFinance/PengajuanGaji/create"
                          ><i class="fa fa-plus"></i>Tambah Pengajuan Gaji</a
                        >
                      </div>
                          ...
                          <tr class="product-removes">
                            ...
                            <td>
                              <div class="product-action">
                                <a href="/dashboardFinance/PengajuanGaji/{{ $gajiPending->id }}">
                                  <i class="fa fa-eye"></i>
                                </a>
                                <form action="/dashboardFinance/PengajuanGaji/{{ $gajiPending->id }}" method="POST" style="display:inline;">
                                  @csrf
                                  @method('DELETE')
                                  <button type="submit" onclick="return confirm('Yakin ingin menghapus?')" style="border: none; background: none;">
